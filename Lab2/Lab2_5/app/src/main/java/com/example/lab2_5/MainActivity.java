...
public class MainActivity extends AppCompatActivity {
        ...
        buttonthem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!tenmon.equals("")) {
                    ...
                    Toast.makeText(MainActivity.this, "Please enter the name of the dish", Toast.LENGTH_SHORT).show();
                }
    ...
    private List<Category> getListCategory() {
        ...
        List.add(new Category("Thumbnail 1",R.drawable.a1));
        List.add(new Category("Thumbnail 2", R.drawable.a2));
        List.add(new Category("Thumbnail 3", R.drawable.a3));
        List.add(new Category("Thumbnail 4", R.drawable.a4));
        return List;
    }
